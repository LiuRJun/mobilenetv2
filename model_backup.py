...
class MobileNet_v2(nn.Module):
    def __init__(self,theta=1,num_classes=10,init_weight=True):
        ...
        #[inchannel,t,out_channel,stride] ==》[输入通道数，通道数扩展倍数，输出通道数，步长]
        ...
        # baseConv(param1:输入通道数， param2:输出通道数，param3:卷积核尺寸， param4:分组数， param5: 步长)
        ...
        #print("......................................")
        #print("self.module[:-1]", *self.module[2:18])
